...
export const content: Content = {
  ...
  copy: {
    ...
    reveal: {
      headline: 'Happy Birthday, Akchaya ❤️',
      message:
    ...
    cake: {
      ...
      cutDone: 'Happy Birthday, Akchaya! 🎉',
      cta: 'What’s next? ❤️',
    },
    ...
    wishesIntro: {
      line: 'Thirty-six wishes, from everyone who loves you.',
    ...
    letter: {
      ...
      body:
        ...
        'Thirty years ago the world got you, and somewhere along the way I got ' +
      ...
      signedBy: '', // ← your name (blank hides this line)
      cta: 'One last thing ❤️',
    },

    finale: {
      headline: 'Happy Birthday Once Again, Akchaya ❤️',
      message:
      ...
      shareText: 'Happy Birthday, Akchaya! ❤️',
