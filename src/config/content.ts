...
export interface Content {
  ...
  media: {
    ...
    music: string
    /**
     * The special video, in order. It is split into parts to stay under
     * GitHub's 25 MB web-upload limit; the player joins them back together
     * and plays them as one continuous video.
     */
    specialVideo: string[]
  }
...
export const content: Content = {
  ...
  media: {
    ...
    specialVideo: [
      mediaUrl('videos/special-video-1.mp4'),
      mediaUrl('videos/special-video-2.mp4'),
    ],
  },
